    ...
    <div class="person-body">
        ...
        <div class="person-left">
            ...
            <div class="first-info">
                ...
                <label>苏州市</label>
                <select>
                    <option id="address-name">${receiveAddress.addressName}</option>
                    <option>虎丘区</option>
                    <option>平江区</option>
                    <option>吴中区</option>
                    <option>吴江区</option>
            ...
            <div class="first-info">
                <span>详细地址</span>
                <input id="address-detail" value="${receiveAddress.addressDetail}" class="address_info" type="text" placeholder="建议您如实填写详细收货地址，如街道名称、门牌号码、楼层和房间号等信息"/>
            </div>
            <div class="first-info">
                <span>收件人姓名</span>
                <input id="receive-name" value="${receiveAddress.clientName}" type="text" class="other-input" />
            </div>
            <div class="first-info">
                <span>手机号码</span>
                <input id="telephone" value="${receiveAddress.clientTelephone}" type="text" class="other-input" />
            </div>

            <button type="submit" class="btn btn-primary" onclick="saveUpdateAddress()">保存</button>
        </div>
    </div>
</div>
<%-------------------------------------------------------------%>
...
<script>
    ...
    function saveUpdateAddress() {
        var addressName = document.getElementById("address-name").innerText;
        ...
        var defaultAddress = document.getElementById("defaultAddress").innerText;
        console.log("defaultAddress = " + defaultAddress);
        var fields1 = document.getElementById("fields1").innerText;
        ...
        var url = "/receiveAddress/updateReceiveAddress?addressName="+addressName+"&addressDetail="+addressDetail+"&clientName="+receiveName+"&clientTelephone="+telephone+"&addressId="+addressId+"&clientId="+clientId+"&defaultAddress="+defaultAddress+"&fields1="+fields1;
